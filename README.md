...
1. #### clone the repo using this command
    ```bash
    git clone https://github.com/sandeeprajkanna/e-commerce-website.git
    ```
2. #### install npm packages
    ...
    npm install
    ```
3. go to the parent folder of mern-ecommerce and create .env for connection, JWT_SECRET, BRAINTREE_MERCHANT_ID, BRAINTREE_PUBLIC_KEY and BRAINTREE_PRIVATE_KEY.
...
6. <b>Deployed on</br> (To be deployed) 
7. Contact info - sandeepraj5254@gmail.com